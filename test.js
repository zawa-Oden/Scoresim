...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        document.cookie = cookies[0] + expire + ';';
        document.cookie = cookies[1] + expire + ';';
        document.cookie = cookies[2] + expire + ';';
        document.cookie = cookies[3] + expire + ';';
        document.cookie = cookies[4] + expire + ';';
        document.cookie = cookies[5] + expire + ';';
