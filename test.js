...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        JSON.stringify()*/
        document.cookie = cookies[0] + ';max-age=8640000000;';
        document.cookie = cookies[1] + ';max-age=8640000000;';
        document.cookie = cookies[2] + ';max-age=8640000000;';
        document.cookie = cookies[3] + ';max-age=8640000000;';
        document.cookie = cookies[4] + ';max-age=8640000000;';
        document.cookie = cookies[5] + ';max-age=8640000000;';
