...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        document.cookie = 'front02=' + JSON.stringify(cookies[1]) + '; max-age=8640000000;';
        document.cookie = 'front03=' + JSON.stringify(cookies[2]) + '; max-age=8640000000;';
        document.cookie = 'front04=' + JSON.stringify(cookies[3]) + '; max-age=8640000000;';
        document.cookie = 'front05=' + JSON.stringify(cookies[4]) + '; max-age=8640000000;';
