...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        JSON.stringify()*/
        document.cookie = 'front1=' + JSON.stringify(cookies[0]);
        document.cookie = 'front2=' + JSON.stringify(cookies[1]);
        document.cookie = 'front3=' + JSON.stringify(cookies[2]);
        document.cookie = 'front4=' + JSON.stringify(cookies[3]);
        document.cookie = 'front5=' + JSON.stringify(cookies[4]);
        document.cookie = 'front6=' + JSON.stringify(cookies[5]);
