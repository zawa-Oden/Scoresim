...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        JSON.stringify()*/
        document.cookie = front1 + '=' + cookies[0];
        document.cookie = front2 + '=' + cookies[1];
        document.cookie = front3 + '=' + cookies[2];
        document.cookie = front4 + '=' + cookies[3];
        document.cookie = front5 + '=' + cookies[4];
        document.cookie = front6 + '=' + cookies[5];
