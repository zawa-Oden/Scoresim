...
var selectfront = {'front01':'フロント1','front02':'フロント2','front03':'フロント3','front04':'フロント4','front05':'フロント5','front06':'フロント6'}
    ...
    function frontsave(){
        ...
        for(let i = 0 ; i < 6 ; i++){
            cookies[i] = encodeURIComponent(JSON.stringify(frontsavearr[i])) + ';';
        }
        period = 100; //保存日数
        expire = new Date();
        expire.setTime(expire.getTime() + 1000 * 3600 * 24 * period);
        /*cookies += 'expires=' + expire + ';';*/
        document.cookie = cookies[0] + 'expires=' + expire + ';';
        document.cookie = cookies[1] + 'expires=' + expire + ';';
        document.cookie = cookies[2] + 'expires=' + expire + ';';
        document.cookie = cookies[3] + 'expires=' + expire + ';';
        document.cookie = cookies[4] + 'expires=' + expire + ';';
        document.cookie = cookies[5] + 'expires=' + expire + ';';
